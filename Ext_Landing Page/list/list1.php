              ...
              <div class="p-1 h-100 sticky-top">
                  <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" style="background-color: #b7d1e2;"id="menu">
                      <li class="nav-item ">
                          ...
                          <a href="/FYP Automation System2/Ext_Landing Page/project individual pages/index_cs1.php" class="nav-link px-0 align-middle">
                            <span class="ms-1 d-none d-sm-inline text-dark" style="font-size: 18px;">CSPROJ-12</span> </a>

                          <a href="/FYP Automation System2/Ext_Landing Page/project individual pages/index_se.php" class="nav-link px-0 align-middle">
                              <span class="ms-1 d-none d-sm-inline text-dark" style="font-size: 18px;">SEPROJ-22</span> </a>
              ...
              <div>
                ...
                <table class="table table-striped container" style="cursor: pointer;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">1</th>
                      <th onclick="location.href = '/FYP Automation System2/Ext_Landing Page/project individual pages/index_cs1.php';">CSPROJ-12</th>
                    ...
                    <tr>
                      <th scope="row">1</th>
                      <th onclick="location.href ='/FYP Automation System2/Ext_Landing Page/project individual pages/index_se.php';">SEPROJ-22</th>
                      <td>Tawakal O Sukoon</td>
                      <!--td>Ms. Tehreem Qamar</td>
                      <td>Sir. Zeeshan</td-->
                      <td>Hareem Imran, Insharah Riaz, Ujala Shah</td>
                      <td>Complete</td>
                    ...
                    <tr>
                      <th scope="row">2</th>
                      <th onclick="location.href = '/FYP Automation System2/Sup_Landing Page/project individual pages/index_cs2.php';">CSPROJ-14</th>
                      <td>Silai Karhai </td>
