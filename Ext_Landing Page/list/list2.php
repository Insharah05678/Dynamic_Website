...
<div class="wrapper">
	<div class="navbar">
      ...
      <img src="/FYP Automation System2/images/o.png" alt="JUW" href="#!" style="cursor: pointer; width: 35%; margin-left: -4%; margin-top: -0%;" >
        ...
        <img src="/FYP Automation System2/images/y.png" alt="profile_img"  style="margin-left: 50%;"><p><strong>External</strong></p>
                ...
                <li onclick="location.href = '/FYP Automation System2/Ext_Landing Page/profile.php';">Profile</li>
								<li onclick="location.href = '/FYP Automation System2/Ext_Landing Page/not.php';">Notification</li>
								<li onclick="location.href = '/FYP Automation System2/Ext_Landing Page/sett.php';">Preferences</li>
              ...
              <div class="p-1 h-100 sticky-top">
                  <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" style="background-color: #b7d1e2;"id="menu">
                      <li class="nav-item ">
                          ...
                          <a href="#" class="nav-link align-middle px-0">
                            <span class="ms-1 d-none d-sm-inline text-dark"style="font-size: 20px;"> CS/SE Program</span></a>
                             
                          <div class="mb-4 text-dark w-500 h-500"><!-- Solid divider -->
                            <hr class="solid">
                          </div>
                              
                          <a href="/FYP Automation System2/Ext_Landing Page/project individual pages/index_cs2.php" class="nav-link px-0 align-middle">
                            <span class="ms-1 d-none d-sm-inline text-dark" style="font-size: 18px;">CSPROJ-13</span> </a>

                          <a href="/FYP Automation System2/Ext_Landing Page/project individual pages/index_cs3.php" class="nav-link px-0 align-middle">
                              <span class="ms-1 d-none d-sm-inline text-dark" style="font-size: 18px;">CSPROJ-14</span> </a>

                          <a href="/FYP Automation System2/Ext_Landing Page/project individual pages/index_se1.php" class="nav-link px-0 align-middle">
                              <span class="ms-1 d-none d-sm-inline text-dark"style="font-size: 18px;">SEPROJ-23</span> </a>
              ...
              <div>
                ...
                <table class="table table-striped container" style="cursor: pointer;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">2</th>
                      <th onclick="location.href = '/FYP Automation System2/Ext_Landing Page/project individual pages/index_cs2.php';">CSPROJ-13</th>
                      <td>DeFear</td>
                      <!--td>Ms. Narmeen</td>
                      <td>Ms. Kanwal</td-->
                    ...
                    <tr>
                      <th scope="row">2</th>
                      <th onclick="location.href = '/FYP Automation System2/Ext_Landing Page/project individual pages/index_cs3.php';">CSPROJ-14</th>
                      <td>Silai Karhai </td>
                    ...
                    <tr>
                      <th scope="row">2</th>
                      <th onclick="location.href = '/FYP Automation System2/Ext_Landing Page/project individual pages/index_se1.php';">SEPROJ-23</th>
                      <td>Creative Hub</td>
                      <!--td>Ms. Samia Ghazala</td>
                      <td>Ms. Kanwal</td-->
                      <td>Arisha Naz, Mashal Noor,Nabatahil Riaz, Syeda Aleeza</td>
                      <td>Complete</td>
                      <td>15 - November - 2022</td>
                    </tr>
                    <!--<tr>
                      <th scope="row">2</th>
                      <th onclick="location.href = '../FYPLanding Page/index_cs2.php';">CSPROJ-14</th>
                      <td>DeFear</td>
                      <td>Complete</td>
                      <td>Hafsa Abbasi, Manal Fouad, Marium Imran, Mehak Dayalal</td>
                      <td>3 - Decemeber - 2022</td>
