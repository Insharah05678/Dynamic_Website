...
<body>
  ...
  <div class="wrapper" style="margin-top: -2%;">
    <div class="navbar">
      ...
      <div class="logo">
        <img src="../images/o.png" alt="JUW" href="#!" style="cursor: pointer; width: 34%; margin-left: -4%; margin-top: -2%;" >
        ...
        <ul>
          <li class="nr_li dd_main" >
            ...
            <div class="dd_menu">
              ...
              <div class="dd_right">
                <ul>
                  <li onclick="location.href = '../Ext_Landing Page/profile.php';">Profile</li>
								  <li onclick="location.href = '../Ext_Landing Page/not.php';">Notification</li>
								  <li onclick="location.href = '../Ext_Landing Page/sett.php';">Preferences</li>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      <h4>Name</h4>
                      <p class="text-secondary mb-1">External</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" onclick="location.href = '#';" role="tab" aria-controls="profile" aria-selected="false" style="cursor: pointer;">Dashboard</a>
                                </li>
                                <li class="nav-item">
