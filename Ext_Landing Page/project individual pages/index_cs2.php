                  ...
                  <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" style="background-color: #b7d1e2;" id="menu">
                      <li class="nav-item ">
                          ...
                          <a href="#" class="nav-link px-0 align-middle">
                            <span class="ms-1 d-none d-sm-inline text-dark"  style="font-size: 18px;">Proposal</span> </a>

                          <a href="#" class="nav-link px-0 align-middle">
                              <span class="ms-1 d-none d-sm-inline text-dark"  style="font-size: 18px;">ERD</span> </a>

                          <a href="#" class="nav-link px-0 align-middle">
                              <span class="ms-1 d-none d-sm-inline text-dark"  style="font-size: 18px;">SRS</span> </a>
            ...
            <div class="card text-black"  style="border:none; margin-left: 10px;">
              ...
              <div>
                ...
                <table class="table table-striped container">
                  <thead>
                    <tr>
                      <th class="tableHead" scope="col" colspan="5">DeFear  |  CSPROJ-13 </th>
                    </tr>
                  </thead>
                  <tbody>
