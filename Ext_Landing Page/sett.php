...
<html lang="en">
  <head>
    ...
    <title>JUW | FYP | Preferences Page</title>
		...
		<div class="nav_right">
			<ul>
				<li class="nr_li dd_main">
					<img src="../images/y.png" alt="profile_img"  style="margin-left: 50%;"><p><strong>External</strong></p>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" onclick="location.href = '/FYP Automation System2/Ext_Landing Page/profile.php';" role="tab" aria-controls="home" aria-selected="true"style="cursor: pointer;">Profile</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" onclick="location.href = '/FYP Automation System2/Ext_Landing Page/not.php';" role="tab" aria-controls="home" aria-selected="true"style="cursor: pointer;">Notification</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" onclick="location.href = '/FYP Automation System2/Ext_Landing Page/sett.php';" role="tab" aria-controls="home" aria-selected="true"style="cursor: pointer;">Preferences</a>
                                </li>
                            </ul>
                            <br>
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <h6 class="mb-3 h3" id="profile"><center>Preferences</center></h6>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0 h5" style="cursor: pointer;" >User Account</h6>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0"style="cursor: pointer;" >Edit Profile</h6>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0" style="cursor: pointer;" >Edit Password</h6>
                    </div>
                  </div>
