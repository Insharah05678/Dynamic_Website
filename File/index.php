...
<div class="wrapper">
	<div class="navbar">
		...
		<div class="logo">
      <img src="../images/o.png" alt="JUW" href="#!" style="cursor: pointer; width: 35%; margin-left: -4%; margin-top: -0%;" >
			
		</div>
		<div class="nav_right">
			<ul>
				<li class="nr_li dd_main">
					<img src="../images/y.png" alt="profile_img"  style="margin-right: 50%; "><p><strong>Student</strong></p>
...
<hr>
<div class="container">
  <div class="row flex-grow-sm-1 flex-grow-0 " style="cursor: pointer; margin-top: -2%; margin-left: -6%; display: flex; width: 90%;">
              ...
              <div class="p-1 h-100 sticky-top">
                  <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" style="background-color: #b7d1e2;" id="menu">
                      <li class="nav-item ">
                          ...
                          <a href="#" class="nav-link px-0 align-middle">
                              <span class="ms-1 d-none d-sm-inline text-dark" onclick="location.href = '/FYP Automation System2/File/poster.php';" style="font-size: 18px;">Posters</span></a>
                      </li>
                  </ul> 
              </div>
          </aside>
...
<!--div class="container"-->
    <div class="main-body" style=" margin-top: -40%;">
                ...
                <hr>
                  <div class="row">
                    <div class="col-sm-3">
                      ...
                      <h6 class="mb-0" id="profile">Grading</h6>
                    </div>
...
if (isset($_POST["submit"]))
 {
    ...
    #file name with a random number so that similar dont get replaced
     ...
     if (in_array($text,$extensions) === true && $filesize<2097152) {
       ...
       $sql = "INSERT into file (erd) VALUES('$pname')";
       if(mysqli_query($conn,$sql)){
        echo "File Sucessfully uploaded";}
       else{
        echo '<script type="text/javascript"> window. onload = function () { alert("Error!.. this user not enrolled"); } </script>';
            }
        }
     }
