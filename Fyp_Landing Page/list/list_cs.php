              ...
              <div class="p-1 h-100 sticky-top">
                  <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" style="background-color: #b7d1e2;"id="menu">
                      <li class="nav-item ">
                          ...
                          <a href="/FYP Automation System2/Fyp_Landing Page/project individual pages/index_cs2.php" class="nav-link px-0 align-middle">
                          ...
                          <a href="/FYP Automation System2/Fyp_Landing Page/project individual pages/index_cs3.php" class="nav-link px-0 align-middle">
              ...
              <div>
                ...
                <table class="table table-striped container" style="cursor: pointer;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">1</th>
                      <th onclick="location.href = '/FYP Automation System2/Fyp_Landing Page/project individual pages/index_cs1.php';">CSPROJ-12</th>
                    ...
                    <tr>
                      <th scope="row">2</th>
                      <th onclick="location.href = '/FYP Automation System2/Fyp_Landing Page/project individual pages/index_cs2.php';">CSPROJ-13</th>
                      <td>DeFear</td>
                      <!--td>Ms. Anisa</td>
                    ...
                    <tr>
                      <th scope="row">2</th>
                      <th onclick="location.href = '/FYP Automation System2/Fyp_Landing Page/project individual pages/index_cs3.php';">CSPROJ-14</th>
                      <td>Silai Karhai </td>
                      <!--td>Ms. Anisa</td>
                      <td>Ms. Ummay Faseeha</td-->
