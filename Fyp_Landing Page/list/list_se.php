		...
		<div class="nav_right">
			<ul>
				<li class="nr_li dd_main">
					<img src="/FYP Automation System2/images/y.png" alt="profile_img"  style="margin-left: 50%;"><p><strong>FYP Member</strong></p>
              ...
              <div class="p-1 h-100 sticky-top">
                  <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" style="background-color: #b7d1e2;"id="menu">
                      <li class="nav-item ">
                          ...
                          <a href="#" class="nav-link align-middle px-0">
                            <span class="ms-1 d-none d-sm-inline text-dark"style="font-size: 20px;"> SE Program</span></a>
                             
                          <div class="mb-4 text-dark w-500 h-500"><!-- Solid divider -->
                            <hr class="solid">
                          </div>
                              
                          <a href="/FYP Automation System2/Fyp_Landing Page/project individual pages/index_se.php" class="nav-link px-0 align-middle">
                            <span class="ms-1 d-none d-sm-inline text-dark" style="font-size: 18px;">SEPROJ-22</span> </a>

                          <a href="/FYP Automation System2/Fyp_Landing Page/project individual pages/index_se1.php" class="nav-link px-0 align-middle">
                              <span class="ms-1 d-none d-sm-inline text-dark" style="font-size: 18px;">SEPROJ-23</span> </a>

                          <!--<a href="../Sup_Landing Page/index_cs3.php" class="nav-link px-0 align-middle">
              ...
              <div>
                ...
                <table class="table table-striped container" style="cursor: pointer;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">1</th>
                      <th onclick="location.href = '/FYP Automation System2/Fyp_Landing Page/project individual pages/index_se.php';">SEPROJ-22</th>
                    ...
                    <tr>
                      <th scope="row">2</th>
                      <th onclick="location.href = '/FYP Automation System2/Fyp_Landing Page/project individual pages/index_se1.php';">SEPROJ-23</th>
                      <td>Creative Hub</td>
                      <!--td>Ms. Tehreem Qamar</td>
                      <td>Ms. Ummay Faseeha</td-->
