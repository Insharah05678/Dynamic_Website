            ...
            <div class="col-md-7">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" onclick="location.href = '/FYP Automation System2/Std_Landing Page/index_se.php';" role="tab" aria-controls="profile" aria-selected="false" style="cursor: pointer;">Dashboard</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"style="cursor: pointer;">Profile</a>
                                </li>
                                <li class="nav-item">
