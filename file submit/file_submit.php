                    ...
                    <div class="col-md-10 col-lg-8 col-xl-9 order-2 order-lg-1">
                      ...
                      <form class="mx-1 mx-md-4" action="" method="POST">
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          ...
                          <div class="form-outline flex-fill mb-0">
                            <input type="text" name="project_name" id="form3Example3c" class="form-control" placeholder="Project Name" required />
                          </div>
                        </div>
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                          <div class="form-outline flex-fill mb-0">
                            <input type="text"  name="group_members" id="form3Example1c" class="form-control" placeholder="Members_Name" required />
                          </div>
                        </div>
                       ...
                       <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                             <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                            <div class="form-outline flex-fill mb-0">
                             <select name="session" id="form3Example1c" class="form-control">
                        ...
                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                          <button type="submit" name="submit"  class="btn btn-primary btn-lg" onclick="location.href = 'file.php'";>Submit</button>
                        </div>
